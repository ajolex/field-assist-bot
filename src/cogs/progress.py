...
class ProgressCog(commands.Cog):
	...
	async def progress(self, interaction: discord.Interaction) -> None:
		...
		await interaction.response.send_message(format_progress_text(values, "Overall progress"))
	...
	async def team_status(self, interaction: discord.Interaction, team_name: str) -> None:
		...
		await interaction.response.send_message(format_progress_text(values, f"Team {team_name}"))
	...
	async def fo_productivity(self, interaction: discord.Interaction, fo_name: str) -> None:
		...
		await interaction.response.send_message(format_progress_text(values, f"FO {fo_name}"))
